#pragma once  // Proper include guard
...
// Include SuperPoint.hpp for ENV_PARAM macros
...
// Function declarations with inline to avoid multiple definition
inline vector<vitis::ai::library::OutputTensor> sort_tensors(
